...
if [ $operador = "s"  -o  $operador = "S" ]; then
     ...
     if [ $operador = 's' -o $operador = 'S' ]; then  
	     ...
	     ln -s ${DIR_INSTAL_BIN}pseudocodicoapascal ${HOME}/Desktop
	     sudo chmod a=rwx ${HOME}/Desktop/pseudocodicoapascal
	     cp -i ./pseudocodicoapascal.desktop /usr/share/applications
	     sudo chmod a=rx /usr/share/applications/pseudocodicoapascal.desktop
	     ln -s ${DIR_INSTAL_DATOS}iconos/pseudocodicoapascal.png ${DIR_INSTAL_ICONOS}
	     sudo chmod a=rx ${DIR_INSTAL_ICONOS}pseudocodicoapascal.png
     fi
